...
final List<Lesson> englishKeyboardLessons = [
  ...
  Lesson(
    ...
    description: "কীবোর্ডের উপরের নম্বর সারি শিখুন - বাম হাতে 1-5, ডান হাতে 6-0",
    category: "English",
    language: "en",
    difficultyLevel: 2,
    exercises: [
  ...
  Lesson(
    ...
    exercises: [
      ...
      Exercise(text: "45604560456", repetitions: 30, type: ExerciseType.drill, difficultyLevel: 1),
      Exercise(text: "65406540654", repetitions: 25, type: ExerciseType.drill, difficultyLevel: 1),
      Exercise(text: "44405550666", repetitions: 25, type: ExerciseType.drill, difficultyLevel: 1),
      Exercise(text: "4560654045606540", repetitions: 20, type: ExerciseType.drill, difficultyLevel: 1),
      
      // Lower Row Practice (1-2-3)
      Exercise(text: "12301230123", repetitions: 25, type: ExerciseType.drill, difficultyLevel: 1),
      Exercise(text: "32103210321", repetitions: 25, type: ExerciseType.drill, difficultyLevel: 1),
      Exercise(text: "11102220333", repetitions: 20, type: ExerciseType.drill, difficultyLevel: 1),
      
      // Upper Row Practice (7-8-9)
      Exercise(text: "78907890789", repetitions: 25, type: ExerciseType.drill, difficultyLevel: 1),
      Exercise(text: "98709870987", repetitions: 25, type: ExerciseType.drill, difficultyLevel: 1),
      Exercise(text: "77708880999", repetitions: 20, type: ExerciseType.drill, difficultyLevel: 1),
      
      // Column Practice (Vertical)
      Exercise(text: "14701470147", repetitions: 20, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "25802580258", repetitions: 20, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "36903690369", repetitions: 20, type: ExerciseType.drill, difficultyLevel: 2),
      
      // Zero Practice
      Exercise(text: "00000000000", repetitions: 20, type: ExerciseType.drill, difficultyLevel: 1),
      Exercise(text: "10203040506070809", repetitions: 18, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "01020304050607080900", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      
      // Decimal Practice
      Exercise(text: "0.001.102.203.30", repetitions: 18, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "45.6789.0123.45", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      
      // Operators Practice
      Exercise(text: "5+506+607+7", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "9-308-407-5", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "2*304*506*7", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "8/209/306/2", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      
      // Full Numpad (All keys combined)
      Exercise(text: "1234567890", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "0987654321", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      Exercise(text: "1029384756", repetitions: 15, type: ExerciseType.drill, difficultyLevel: 2),
      
      // Real-world Practice
      Exercise(text: "1000200030004000500", repetitions: 12, type: ExerciseType.drill, difficultyLevel: 3),
      Exercise(text: "1500.002750.503999.99", repetitions: 10, type: ExerciseType.drill, difficultyLevel: 3),
      Exercise(text: "123+456-789*0/1", repetitions: 10, type: ExerciseType.drill, difficultyLevel: 3),
    ],
  ),
  Lesson(
