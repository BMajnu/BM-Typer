...
/// Service that handles scheduling and managing practice reminders (IO Implementation)
class ReminderService {
  ...
  static Future<void> scheduleReminder() async {
    ...
    await _notifications.zonedSchedule(
      ...
      body: 'Maintain your streak by practicing typing today.', // Body
      scheduledDate: scheduledDate, // Schedule time
  ...
  static Future<void> showTestNotification() async {
    await _notifications.show(
      id: 99, // Different ID for test notification
      title: 'Practice Reminder Test',
      body: 'This is a test practice reminder notification.',
      notificationDetails: NotificationDetails(
        android: AndroidNotificationDetails(
          _channelId,
          _channelName,
