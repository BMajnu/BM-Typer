  ...
  if (value is Map) {
    ...
    if (seconds is num && nanoseconds is num) {
      return DateTime.fromMillisecondsSinceEpoch(
        (seconds * 1000).toInt() + (nanoseconds / 1000000).round(),
      );
    }
  }
...
class OrganizationModel {
  ...
  factory OrganizationModel.fromJson(Map<String, dynamic> json) {
    return OrganizationModel(
      ...
      expiryDate: _parseDateTimeValue(json['expiryDate']),
      createdAt: _parseDateTimeValue(json['createdAt']) ?? DateTime.now(),
...
class OrgMemberModel {
  ...
  @HiveField(7)
  final String?
      teamLeadId; // User ID of assigned team lead (if this member is a team lead)
  @HiveField(8)
  ...
  factory OrgMemberModel.fromJson(Map<String, dynamic> json) {
    return OrgMemberModel(
      ...
      joinedAt: _parseDateTimeValue(json['joinedAt']) ?? DateTime.now(),
      isActive: json['isActive'] as bool? ?? true,
