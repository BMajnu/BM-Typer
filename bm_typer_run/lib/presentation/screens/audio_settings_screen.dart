...
class _AudioSettingsScreenState extends ConsumerState<AudioSettingsScreen> {
  ...
  late bool _isCompletionSoundEnabled;
  late bool _showTransitionPopup;
  late double _volume;
  ...
  void initState() {
    ...
    _isCompletionSoundEnabled = soundService.isCompletionSoundEnabled;
    _volume = soundService.volume;
    _selectedTheme = soundService.currentTheme;
    _showTransitionPopup = practiceSettingsService.showTransitionPopup;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _buildCompletionSoundToggleCard(colorScheme, isDark),
                      const SizedBox(height: 12),
                      _buildVolumeCard(colorScheme, isDark),
                      const SizedBox(height: 24),
                      _buildSectionTitle('অনুশীলন সহায়তা', isDark),
                      const SizedBox(height: 12),
                      _buildTransitionPopupToggleCard(colorScheme, isDark),
                      const SizedBox(height: 24),
  ...
  Widget _buildCompletionSoundToggleCard(ColorScheme colorScheme, bool isDark) {
    return _buildGlassCard(
      isDark: isDark,
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'প্রতি ধাপ বা রিপিট শেষ হলে যে কনফার্মেশন সাউন্ড বাজে',
                  style: GoogleFonts.hindSiliguri(
                    fontSize: 13,
                    color: (isDark ? Colors.white : Colors.black).withOpacity(0.6),
                  ),
          ...
          Switch(
            value: _isCompletionSoundEnabled,
            onChanged: _isSoundEnabled ? _updateCompletionSoundEnabled : null,
  ...
  Widget _buildTransitionPopupToggleCard(ColorScheme colorScheme, bool isDark) {
    return _buildGlassCard(
      isDark: isDark,
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'নতুন অনুশীলন বা লেসন শুরু হওয়ার আগে ব্যাখ্যামূলক নির্দেশনা দেখান',
                  style: GoogleFonts.hindSiliguri(
                    fontSize: 13,
                    color: (isDark ? Colors.white : Colors.black).withOpacity(0.6),
                  ),
          ...
          Switch(
            value: _showTransitionPopup,
            onChanged: _updateTransitionPopupEnabled,
  ...
  void _updateCompletionSoundEnabled(bool value) async {
    setState(() => _isCompletionSoundEnabled = value);
    await ref.read(soundServiceProvider).setCompletionSoundEnabled(value);
    ref.read(completionSoundEnabledProvider.notifier).state = value;
    if (value && _isSoundEnabled) {
      ref.read(soundServiceProvider).playSound(SoundType.levelComplete);
    }
  }
  ...
  void _updateTransitionPopupEnabled(bool value) async {
    setState(() => _showTransitionPopup = value);
    await PracticeSettingsService().setShowTransitionPopup(value);
  }
}
