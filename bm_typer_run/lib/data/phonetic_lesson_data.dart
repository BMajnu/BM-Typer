...
// ================================================================
// অভ্র বাংলা কীবোর্ড লেসন (Avro-style)
...
final List<Lesson> phoneticBanglaLessons = [
  // ==================================================================================
  // লেসন ৩১: অভ্র হোম রো - বাম হাত (A S D F G)
  // Avro: a=া/আ, s=স, d=দ, f=ফ, g=গ
  // ==================================================================================
  Lesson(
    title: "লেসন ৩১: অভ্র হোম রো বাম (া স দ ফ গ)",
    description: "অভ্র কীবোর্ডের হোম রো - বাম হাত (a s d f g)",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 1,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৩২: অভ্র হোম রো - ডান হাত (H J K L)
  // Avro: h=হ, j=জ, k=ক, l=ল
  // ==================================================================================
  Lesson(
    title: "লেসন ৩২: অভ্র হোম রো ডান (হ জ ক ল)",
    description: "অভ্র কীবোর্ডের হোম রো - ডান হাত (h j k l)",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 1,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৩৩: অভ্র হোম রো - শিফট (Shift + A S D F G H J K L)
  // Avro Shift: A=আ, S=শ, D=ড, G=ঘ, K=খ, J=ঝ
  // ==================================================================================
  Lesson(
    title: "লেসন ৩৩: অভ্র হোম রো - শিফট (আ শ ড ঘ খ ঝ)",
    description: "শিফট সহ অভ্র হোম রো (Shift + A S D F G H J K L)",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 2,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৩৪: অভ্র উপরের সারি - স্বরবর্ণ (E I O U)
  // Avro: e=ে/এ, i=ি/ই, o=অ, u=ু/উ
  // ==================================================================================
  Lesson(
    title: "লেসন ৩৪: অভ্র স্বরবর্ণ (এ ই অ উ)",
    description: "অভ্র স্বরবর্ণ শিখুন - e=এ, i=ই, o=অ, u=উ",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 1,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৩৫: অভ্র উপরের সারি - ব্যঞ্জনবর্ণ (R T Y P)
  // Avro: r=র, t=ত, y=য়, p=প
  // ==================================================================================
  Lesson(
    title: "লেসন ৩৫: অভ্র উপরের সারি (র ত য় প)",
    description: "অভ্র উপরের সারি - r=র, t=ত, y=য়, p=প",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 1,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৩৬: অভ্র নিচের সারি (Z X C V B N M)
  // Avro: z=য, c=চ, v=ভ, b=ব, n=ন, m=ম
  // ==================================================================================
  Lesson(
    title: "লেসন ৩৬: অভ্র নিচের সারি (য চ ভ ব ন ম)",
    description: "অভ্র নিচের সারি - z=য, c=চ, v=ভ, b=ব, n=ন, m=ম",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 1,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৩৭: অভ্র মহাপ্রাণ বর্ণ (kh gh ch jh th dh ph bh)
  // ==================================================================================
  Lesson(
    title: "লেসন ৩৭: অভ্র মহাপ্রাণ বর্ণ (খ ঘ ছ ঝ থ ধ ফ ভ)",
    description: "অভ্র মহাপ্রাণ বর্ণ - kh=খ, gh=ঘ, ch=ছ, jh=ঝ, th=থ, dh=ধ",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 2,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৩৮: অভ্র শব্দ অনুশীলন
  // ==================================================================================
  Lesson(
    title: "লেসন ৩৮: অভ্র শব্দ অনুশীলন",
    description: "অভ্র দিয়ে সাধারণ বাংলা শব্দ টাইপ করুন",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 2,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৩৯: অভ্র বাক্য অনুশীলন
  // ==================================================================================
  Lesson(
    title: "লেসন ৩৯: অভ্র বাক্য অনুশীলন",
    description: "অভ্র দিয়ে সম্পূর্ণ বাংলা বাক্য টাইপ করুন",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 3,
    exercises: [
  ...
  // ==================================================================================
  // লেসন ৪০: অভ্র অনুচ্ছেদ অনুশীলন
  // ==================================================================================
  Lesson(
    title: "লেসন ৪০: অভ্র অনুচ্ছেদ অনুশীলন",
    description: "অভ্র দিয়ে দীর্ঘ অনুচ্ছেদ টাইপ করুন",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 4,
    exercises: [
      ...
      Exercise(
        text: "অভ্র কীবোর্ড ব্যবহার করে বাংলা টাইপ করা সহজ। ইংরেজি উচ্চারণ অনুযায়ী টাইপ করলে বাংলা অক্ষর আসে।",
        repetitions: 3,
        type: ExerciseType.paragraph,
        difficultyLevel: 4,
      ),
  ...
  // ==================================================================================
  // লেসন ৪১: টেক জোন আইটি - অভ্র পেশাদার অনুচ্ছেদ
  // ==================================================================================
  Lesson(
    title: "লেসন ৪১: টেক জোন আইটি - অভ্র অনুশীলন",
    description: "অভ্র দিয়ে টেক জোন আইটি সম্পর্কে বিস্তারিত অনুচ্ছেদ টাইপ করুন",
    category: "Phonetic",
    language: "bn",
    difficultyLevel: 5,
    exercises: [
